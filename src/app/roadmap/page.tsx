...
import {
  ...
  Brain, Shield, Users, Globe, Smartphone, Zap, Heart,
  MessageSquare, Video, Mic, Palette, Target, Star,
...
const ROADMAP_ITEMS: RoadmapItem[] = [
  ...
  {
    id: 'cp-v170', title: 'v17.0 — OWNER Role, Per-Product Checkout, Financial Dashboard', status: 'completed', quarter: 'May 2026',
    category: 'Administration', icon: <Shield size={18} />, impact: 'high',
    description: 'OWNER role with 2FA login, per-product checkout, financial dashboard, price editor, and 3 critical security fixes.',
    details: [
      'OWNER role with 2-step email verification on every sign-in',
      'Per-product checkout flow for individual standalone products',
      'OWNER financial dashboard with revenue and subscription metrics',
      'OWNER price editor (UI + API + override store) for live pricing controls',
      '3 critical security fixes shipped alongside the OWNER rollout',
    ],
    tags: ['OWNER', 'Security', 'Billing'],
  },
  {
    id: 'cp-v171', title: 'v17.1 — Site-Wide UX Sweep', status: 'completed', quarter: 'May 2026',
    category: 'Student Experience', icon: <Sparkles size={18} />, impact: 'high',
    description: 'OWNER nav, per-product subscriptions, entitlement gates, contact form, and AnonShell adoption across unauthed product chrome.',
    details: [
      'OWNER navigation surface integrated across layout and middleware',
      'Per-product subscriptions UI with 402 entitlement handling',
      'Entitlement gates wired across study, practice, and product routes',
      'Contact form un-disabled with a working API and AnonShell shell for anonymous visitors',
      'Stale FAQ cleanup, brand-domain alignment, and marketing copy refresh',
    ],
    tags: ['UX', 'OWNER', 'Entitlements'],
  },
  {
    id: 'cp-v172', title: 'v17.2 — OWNER Seed Automation', status: 'completed', quarter: 'May 2026',
    category: 'Administration', icon: <Database size={18} />, impact: 'medium',
    description: 'OWNER seed automation, OWNER_2FA_EMAIL split, and auto-seed on every deploy.',
    details: [
      'OWNER seed script with documented setup flow',
      'OWNER_2FA_EMAIL split from the operational email to isolate the 2FA challenge inbox',
      'Auto-run OWNER seed on every Render deploy so production OWNER access is never missing',
    ],
    tags: ['OWNER', 'DevOps', 'Automation'],
  },
  {
    id: 'cp-v173', title: 'v17.3 — Post-MFA Fix, AI Tutor Fix, Financial Integrity', status: 'completed', quarter: 'May 2026',
    category: 'AI & Intelligence', icon: <Zap size={18} />, impact: 'high',
    description: 'Post-MFA fix, AI tutor fix, financial integrity hardening, and a systemic UI bug-class fix.',
    details: [
      'Post-MFA 404 fix with OWNER UX polish',
      'AI tutor reply key bug fixed; AI rate limits and entitlement holes closed',
      'Financial integrity hardened: /api/payments unauthenticated onboard removed, duplicate-purchase guards added',
      'Systemic s.value→s.id UI bug class swept across the codebase',
      'Orphaned student routes and mobile nav coverage restored',
    ],
    tags: ['Security', 'AI', 'Bug Fixes'],
  },
];
