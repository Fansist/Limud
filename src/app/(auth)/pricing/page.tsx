...
import {
  ...
  Minus, Users, School, Brain, FileText, BarChart3, Headphones,
  ...
  return (
    <AnonShell>
      ...
      {/* Footer — v17.1: cross-links added to match the landing footer's
          shape (Company + Legal grouping) so visitors don't dead-end here. */}
      <footer className="border-t border-gray-200/50 py-8 text-center space-y-2">
        <p className="text-sm text-gray-500 flex flex-wrap items-center justify-center gap-x-2 gap-y-1">
          ...
          <span className="text-gray-300">&middot;</span>
          <Link href="/roadmap" className="hover:text-gray-700 transition">Roadmap</Link>
          <span className="text-gray-300">&middot;</span>
